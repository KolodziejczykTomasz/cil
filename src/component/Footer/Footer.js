...
const Footer = ({growFontFn, shrinkFontFn, resetFontFn}) => (
  <div className="container container_footer" style={{ width: '100%' }}>
    <div className="row justify-content-md-center row_footer">
      <div className="col col-lg-3 row_footer_item">
        <Link to="/wcag" target='_self' title="Link przenoszący do strony dotyczącej dostępności (strona otwiera się w tym samym oknie)">
          Oświadczenie o dostępności
        </Link>
      </div>
      <div className="col col-lg-3 row_footer_item">
        <Link to="/cookies" target='_self' title="Link przenoszący na stronę polityki prywatności (strona otwiera się w tym samym oknie)">
      ...
      <div className="col col-lg-3 row_footer_item">
        Created by <a href="https://nettom24.com/" target='_self'
                      title="Link przenoszący do strony firmy wykonującej stronę (strona otwiera się w tym samym oknie)">NETTOM24</a>
